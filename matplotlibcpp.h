...
namespace matplotlibcpp
{
    namespace detail
    {
        ...
        struct _interpreter
        {
            ...
            PyObject *s_python_function_broken_barh;
...
#  endif
            ...
            _interpreter()
            {
                ...
                s_python_function_broken_barh = safe_import(pymod, "broken_barh");
...
// a non-numpy alternative for `detail::get_2darray()`.
    ...
    inline
    bool broken_barh(double xrange1, double xrange2, double yrange1, double yrange2,
                     const std::map<std::string, std::string> &keywords = {})
    {
        detail::_interpreter::get();

        PyObject * xranges = Py_BuildValue("[(f, f)]", xrange1, xrange2);
        PyObject * yrange = Py_BuildValue("(f, f)", yrange1, yrange2);

        PyObject * args = PyTuple_New(2);
        PyTuple_SetItem(args, 0, xranges);
        PyTuple_SetItem(args, 1, yrange);
        ...
        PyObject * res = PyObject_Call(detail::_interpreter::get().s_python_function_broken_barh, args, kwargs);
    ...
    inline bool subplots_adjust(const std::map<std::string, double> &keywords = {})
    {
        ...
        PyObject * res = PyObject_Call(detail::_interpreter::get().s_python_function_subplots_adjust, plot_args,
                                       kwargs);
